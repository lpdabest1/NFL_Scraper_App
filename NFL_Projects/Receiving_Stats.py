...
def app():
    st.title('NFL Football Stats (Receiving) Explorer')

    st.markdown("""
This app performs simple webscraping of NFL Football player stats data (focusing on Receiving)!
...
# https://www.pro-football-reference.com/years/2019/receiving.htm
    ...
    def load_data(year):
        ...
        playerstats = playerstats.astype({'Tgt':'int',
                                          'Rec':'int',
                                          'Ctch%':'str',
                                          'Yds':'int',
                                          'Y/R':'str',
...
# Team Data
    if st.button('Receiving Statistics'):
...
# Heatmap
    ...
    if st.sidebar.checkbox('Regression Plots'):
        ...
        unique_columns = ['Tgt','Rec','Ctch%','Yds','Yds/Rec','TD','1D','Lng','Yds/Tgt','Rec/G','Yds/G','Fmb']
        statistical_columns = ['Tgt','Rec','Ctch%','Yds','Yds/Rec','TD','1D','Lng','Yds/Tgt','Rec/G','Yds/G','Fmb']
