...
def app():
    st.title('NFL Football Stats (Scoring) Explorer')

    st.markdown("""
This app performs simple webscraping of NFL Football player stats data (focusing on Scoring)!
...
""")
    ...
    selected_year = st.sidebar.selectbox('Year', list(reversed(range(1940,2023))))

# Web scraping of NFL player stats
# https://www.pro-football-reference.com/years/2019/scoring.htm
    @st.cache
    def load_data(year):
        ...
        playerstats = playerstats.astype({'RshTD':'int',
                                          'RecTD':'int',
                                          'PR TD':'int',
                                          'KR TD':'int',
                                          'FblTD':'int',
...
# Team Data
    if st.button('Player Scoring Statistics'):
...
# Heatmap
    ...
    if st.sidebar.checkbox('Categorical Plots'):
        ...
        unique_columns = ['Team','Pos','RshTD','RecTD','PR TD','KR TD','FblTD','IntTD','OthTD','AllTD','2PM','2PA','XPM','XPA','FGM','FGA','Sfty','Pts','Pts/G']
        statistical_columns = ['RshTD','RecTD','PR TD','KR TD','FblTD','IntTD','OthTD','AllTD','2PM','2PA','XPM','XPA','FGM','FGA','Sfty','Pts','Pts/G']
    ...
    if st.sidebar.checkbox('Regression Plots'):
        ...
        unique_columns = ['RshTD','RecTD','PR TD','KR TD','FblTD','IntTD','OthTD','AllTD','2PM','2PA','XPM','XPA','FGM','FGA','Sfty','Pts','Pts/G']
        statistical_columns = ['RshTD','RecTD','PR TD','KR TD','FblTD','IntTD','OthTD','AllTD','2PM','2PA','XPM','XPA','FGM','FGA','Sfty','Pts','Pts/G']
